...
describe('Authenticate User', () => {
    ...
    it('should be able authenticate an user with cpf and password', async () => {
    ...
    it("shouldn't be able authenticate an user by invalid credentials (non-existent cpf)", async() => {
        const cpf            = "159.235.225-96"
        const password       = "123456"
    ...
    it("shouldn't be able authenticate an user by invalid credentials (invalid password)", async() => {
        const cpf            = "159.235.225-96"
        const name           = "user test"
        const password       = "123456"
        const role           = "ADMIN"
